...
import 'select_room_model.dart';
export 'select_room_model.dart';
...
class _SelectRoomWidgetState extends State<SelectRoomWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectRoomModel());
              ...
              children: [
                    ...
                    child: Container(
                      ...
                      child: Text(
                        valueOrDefault<String>(
                          columnUserDetailsRecord?.email,
                          'Email',
                        ),
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Readex Pro',
                              color: const Color(0xFF104974),
                              fontSize: 30.0,
                              letterSpacing: 0.0,
                            ),
                      ),
                ...
                FFButtonWidget(
                  onPressed: () async {
                    ...
                    context.pushNamedAuth('StartingPage', context.mounted);
                  },
                  text: 'Log Out',
                  options: FFButtonOptions(
                    height: 40.0,
