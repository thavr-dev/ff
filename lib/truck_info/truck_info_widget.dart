...
import 'truck_info_model.dart';
export 'truck_info_model.dart';

class TruckInfoWidget extends StatefulWidget {
  const TruckInfoWidget({super.key});
...
class _TruckInfoWidgetState extends State<TruckInfoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TruckInfoModel());
