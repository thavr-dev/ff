...
import 'schema/random_integer_store_record.dart';
...
export 'schema/random_integer_store_record.dart';
...
/// Functions to query RandomIntegerStoreRecords (as a Stream and as a Future).
Future<int> queryRandomIntegerStoreRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RandomIntegerStoreRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RandomIntegerStoreRecord>> queryRandomIntegerStoreRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RandomIntegerStoreRecord.collection,
      RandomIntegerStoreRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RandomIntegerStoreRecord>> queryRandomIntegerStoreRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
