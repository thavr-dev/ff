  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<RandomIntegerStoreRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RandomIntegerStoreRecord> roomJoinRandomIntegerStoreRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final roomJoinRandomIntegerStoreRecord =
            roomJoinRandomIntegerStoreRecordList.isNotEmpty
                ? roomJoinRandomIntegerStoreRecordList.first
                : null;
